...
namespace mantle {
    ...
    FGImageHandle FrameGraph::create_image(const ImageDesc &desc) {
        ...
        m_images[handle.index] = FGImageEntry{.desc = desc};
    ...
    FGBufferHandle FrameGraph::create_buffer(const BufferDesc &desc) {
        ...
        m_buffers[handle.index] = FGBufferEntry{.desc = desc};
